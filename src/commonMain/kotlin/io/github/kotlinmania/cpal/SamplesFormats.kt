...
data class U48(val value: ULong) {
    init {
...
enum class SampleFormat {
    ...
    fun isInt(): Boolean = when (this) {
        I8, I16, I32, I64 -> true
        U8, U16, U32, U64, F32, F64 -> false
    }

    fun isUInt(): Boolean = when (this) {
        U8, U16, U32, U64 -> true
