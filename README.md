# cpal-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fcpal--kotlin-blue.svg)](https://github.com/KotlinMania/cpal-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/cpal-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/cpal-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/cpal-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/cpal-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`RustAudio/cpal`](https://github.com/RustAudio/cpal).

**Original Project:** This port is based on [`RustAudio/cpal`](https://github.com/RustAudio/cpal). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `RustAudio/cpal`

> The text below is reproduced and lightly edited from [`https://github.com/RustAudio/cpal`](https://github.com/RustAudio/cpal). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
See the [beep example](https://github.com/RustAudio/cpal/blob/HEAD/examples/beep.rs) for selecting the host at runtime.
...
Contributions are welcome! Please see [CONTRIBUTING.md](https://github.com/RustAudio/cpal/blob/HEAD/CONTRIBUTING.md) for guidelines.

## Resources

- **Documentation:** [docs.rs/cpal](https://docs.rs/cpal)
- **Examples:** [examples/](https://github.com/RustAudio/cpal/blob/HEAD/examples/) directory in this repository
...
Licensed under the Apache License, Version 2.0. See [LICENSE](https://github.com/RustAudio/cpal/blob/HEAD/LICENSE) for details.
...
This Kotlin port is distributed under the same Apache-2.0 license as the upstream [`RustAudio/cpal`](https://github.com/RustAudio/cpal). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the cpal authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`RustAudio/cpal`](https://github.com/RustAudio/cpal) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
