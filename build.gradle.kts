...
kotlin {
    ...
    val xcf = XCFramework("Cpal")

    macosArm64 {
        binaries.framework { baseName = "Cpal"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Cpal"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Cpal"
        flattenPackage = "io.github.kotlinmania.cpal"
    }

    android {
        namespace = "io.github.kotlinmania.cpal"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "cpal-kotlin", version.toString())

    pom {
        name.set("cpal-kotlin")
        description.set("Kotlin Multiplatform port of RustAudio/cpal - Low-level cross-platform audio I/O library in pure Rust")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/cpal-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/cpal-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/cpal-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/cpal-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleCpalXCFramework",
    "assembleCpalDebugXCFramework",
    "assembleCpalReleaseXCFramework",
    "assembleDebugIosFatFrameworkForCpalXCFramework",
    "assembleReleaseIosFatFrameworkForCpalXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForCpalXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForCpalXCFramework",
    "assembleDebugMacosFatFrameworkForCpalXCFramework",
    "assembleReleaseMacosFatFrameworkForCpalXCFramework",
    "assembleDebugTvosFatFrameworkForCpalXCFramework",
    "assembleReleaseTvosFatFrameworkForCpalXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForCpalXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForCpalXCFramework",
    "assembleDebugWatchosFatFrameworkForCpalXCFramework",
    "assembleReleaseWatchosFatFrameworkForCpalXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForCpalXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForCpalXCFramework",
