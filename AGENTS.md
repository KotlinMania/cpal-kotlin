...
This file is the quick-reference operating contract for cpal-kotlin. The longer
...
cpal-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`cpal`](https://crates.io/crates/cpal). Upstream Rust is the behavioral oracle while the
